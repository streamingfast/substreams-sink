...
* Default flag `--undo-buffer-size` has been set to 0 by default instead of 12, to avoid adding delay by omission.
...
* Fixed in error happening in `0.5.3` with a nil pointer exception.
